...
f = open('nbmodel_part2.txt', 'r', encoding="latin1")
lines = f.readlines()
# print(len(lines))
...
# write to nboutput2.txt
text_file = open("nboutput2.txt", "w", encoding="latin1")	
...
text_file_precision = open('nboutput2.txt', 'r', encoding="latin1")
...
# recall
text_file_recall = open('nboutput2.txt', 'r', encoding="latin1")
belongs_in_ham = 0
belongs_in_spam = 0
